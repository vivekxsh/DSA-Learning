...
### Nearby cars problems

![nearby cars](images/image12.png)
...
public class NearbyCars {
    ...
    static class Point implements Comparable<Point> {
        ...
        public int compareTo(Point p2) {
            return this.distSq - p2.distSq; // sort in ascending
        }
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < k; i++) {
            ...
            System.out.println(pts[i][pq.remove().idx]);
        }
...
![connect ropes](images/image13.png)

---

![connect ropes](images/image14.png)
...
![soldier](images/image15.png)

---

![soldier](images/image16.png)
