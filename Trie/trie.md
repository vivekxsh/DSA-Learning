...
### Count Unique Substring from a string

![substring](images/image7.png)
...
public class CountUniqueSubString2 {
    static class Node {
        Node children[] = new Node[26];
        boolean eow = false;
